...
public class GoldCupHighlights extends AppCompatActivity {

    private static final String CACHE_PREFS = "HighlightsCache";
    private static final String CACHE_KEY = "CachedPhotos";
    private static final String TIMESTAMP_KEY = "CacheTimestamp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gold_cup_highlights);

        galleryRecyclerView = findViewById(R.id.imageListRecycler);

        // Initialize Firebase Realtime Database Reference
        databaseReference = FirebaseDatabase.getInstance().getReference("Highlights").child("GoldCupHighlights");
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (photoList.isEmpty()) {
                    Toast.makeText(GoldCupHighlights.this, "No photos found.", Toast.LENGTH_SHORT).show();
                } else {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(GoldCupHighlights.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
